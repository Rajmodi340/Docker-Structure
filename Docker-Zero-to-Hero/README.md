...
```
git clone https://github.com/Rajmodi340/Docker-Zero-to-Hero
cd  examples
```
...
```
docker build -t rajmodi09/my-first-docker-image:latest .
```
...
```
docker run -it rajmodi09/my-first-docker-image
```
...
```
docker push rajmodi09/my-first-docker-image
```
